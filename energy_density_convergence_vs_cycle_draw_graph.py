...
with sns.axes_style("whitegrid"):
    ...
    plt.sca(ax)
    text_scale = 1.5
    plt.xlabel('$n$ (cycle no.)', fontsize=str(int(16*text_scale)), fontname='Times New Roman')#, fontweight='bold')
    plt.ylabel('$e - e_\mathrm{steady}$', fontsize=str(int(20*text_scale)), fontname='Times New Roman')#, fontweight='bold')
    plt.tick_params(axis='both', which='major', labelsize=int(13*text_scale))
    plt.tight_layout()
    ...
    text_scale = 3.
    plt.sca(ax_inset)
    plt.xlabel('$T$', fontsize=str(int(20*text_scale)), fontname='Times New Roman')#, fontweight='bold')
    plt.ylabel('$e_\mathrm{steady}$', fontsize=str(int(20*text_scale)), fontname='Times New Roman')#, fontweight='bold')

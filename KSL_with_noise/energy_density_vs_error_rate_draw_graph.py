...
results_df = results_df.query(f"num_sites_x == {num_sites_x} & num_sites_y == {num_sites_y} & Nt == {trotter_steps} & N_iter == {cycles}")
...
with sns.axes_style("whitegrid"):
    ...
    plt.errorbar(results_df.errors_per_cycle_per_qubit, results_df.energy_density, yerr=results_df.energy_density_std, linestyle='None', marker=marker)

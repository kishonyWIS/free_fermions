...
with sns.axes_style("whitegrid"):
    ...
    plt.xlabel('Errors per cycle per qubit', fontsize=str(int(16*text_scale)), fontname='Times New Roman')#, fontweight='bold')
    ...
    plt.legend(prop=mpl.font_manager.FontProperties(family='Times New Roman', size=int(13*text_scale)))
    plt.tight_layout()

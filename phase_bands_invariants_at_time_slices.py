...
if mode == 'numerical':
    point_singularities_0, point_singularities_pi, line_singularities_0, line_singularities_pi =\
        plot_singularities_3d(ky, 22, 0.05, ax, pulse_length=pulse_length, plot=False, plot_numerical_singularities=True)
if mode == 'manual':
    point_singularities_0, point_singularities_pi, line_singularities_0, line_singularities_pi =\
        plot_singularities_3d(ky, 22, 0.05, ax, pulse_length=pulse_length, plot=False, plot_numerical_singularities=False)

    surf = ax.plot_surface(KX, THETA, TIME, cmap=matplotlib.cm.plasma.reversed(), alpha=0.7, linewidth=0,

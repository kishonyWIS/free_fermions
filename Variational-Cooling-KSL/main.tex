...
Throughout this section, we present results for the chiral phase of the Kitaev spin liquid model with exchange couplings $\mathcal{J}_x = \mathcal{J}_y = \mathcal{J}_z = 1$ and three-spin interaction strength $\kappa = 1$. We use $T_{\text{train}} = 5$ cooling cycles to train the circuit.
